...
[Y1, T1] = eulerMethod(h1, 0, b, ivp1, fx);
...
plot(T1, Y1, 'o', 'DisplayName', 'euler');
legend; hold off;

[Y2, T2] = eulerMethod(h2, 0, b, ivp1, fx);
...
plot(T2, Y2, 'o', 'DisplayName', 'euler');
legend; hold off;

[Y3, T3] = eulerMethod(h3, 0, b, ivp1, fx);
...
plot(T3, Y3, 'o', 'DisplayName', 'euler');
legend; hold off;
...
[Y4, T4] = eulerMethod(h1, 0, b, ivp2, bx);
...
plot(T4, Y4, 'o', 'DisplayName', 'euler');
legend; hold off;

[Y5, T5] = eulerMethod(h2, 0, b, ivp2, bx);
...
plot(T5, Y5, 'o', 'DisplayName', 'euler');
legend; hold off;

[Y6, T6] = eulerMethod(h3, 0, b, ivp2, bx);
...
plot(T6, Y6, 'o', 'DisplayName', 'euler');
legend; hold off;
